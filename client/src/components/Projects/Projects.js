            ...
            projects : [
                {
                    ...
                    image: blumber,
                    reason: "When I was in university, I found some courses to be extremely challenging. I would go to lectures, but there was no way I can grasp everything the professor was saying the first go round. Therefore, one day, I decided to video record the lecture and it helped immensely. That's where I got the idea for Blumber. I decided that it would be a great idea for previous student who have already excelled in the course to provided detailed video lectures about the university class. This way, a student can go over the concept at his/her pace and not have to worry about missing information.",
                    techStack: "To build this application, I used React, Redux, Node, Express and MongoDB. Authentication was done via Passport.js and the user data was stored in a user document in MongoDB Atlas. Payment handling was done with Stripe.js. Redux was used to communicate authentication status to necessary pages and to centralize courses in the cart.",
                    techStackImages: [react, redux, mongo, passport, stripe, node],
                    status: "Almost Complete / Not Deployed",
                ...
                },
                {
                    ...
                    image: greatrr,
                    reason: "In my forth year in university I read the book Outliers by Malcolm Gladwell. It was one of the most fascinating and informative book I've ever read. One concept that stood out to me was the fact that to be an outlier in a particular area you must first 10,000 hours to its mastery. It really got me thinking how much time was I devoting towards the things I wanted to be great at. To find out, I started tracking every minute of my day. I instantly become 10 times more productive and my self-esteem shot up. At the time I was tracking my habits and time in pen and paper. Now I want to make a real application that you and I can benefit from!",
                    techStack: "To build this application, I used React, Redux, Node, Express and MongoDB. Authentication was done via Passport.js and the user data was stored in a user document in MongoDB Atlas. All non-user data are stored as subdocuments in the appropriates user document.",
                    techStackImages: [react, redux, mongo, passport, node],
                    status: "Current Project / Not Complete / Deployed",
